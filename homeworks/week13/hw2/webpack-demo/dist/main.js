...
function init(options) {
  ...
  getNewComments()
  jquery__WEBPACK_IMPORTED_MODULE_3___default()(commentsSelector).on('click', '.' + loadMoreClassName, () => {
    getNewComments()
  })
  jquery__WEBPACK_IMPORTED_MODULE_3___default()(formSelector).submit( (e) => {
    ...
    ;(0,_api__WEBPACK_IMPORTED_MODULE_0__.addComments)(apiUrl, siteKey, datas, data => {
      if (!data.ok) {
        alert(data.msg)
        return
      }
      nickNameDom.val(''),
      contentDom.val('')
      const commentToDom = jquery__WEBPACK_IMPORTED_MODULE_3___default()(commentsSelector)
      ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.appendCommentToDom)(commentToDom, datas, true)
    })
  })
  ...
  function getNewComments() {
      ...
      for (let comment of comments) {
        ;(0,_utils__WEBPACK_IMPORTED_MODULE_1__.appendCommentToDom)(commentToDom, comment, false)
      }
      ...
      if (length === 0) {
        ...
        const lodaMoreButtonHTML = (0,_templates__WEBPACK_IMPORTED_MODULE_2__.getLoadMoreButton)(loadMoreClassName)
        jquery__WEBPACK_IMPORTED_MODULE_3___default()(commentsSelector).append(lodaMoreButtonHTML)
      }
    })
  }
}
